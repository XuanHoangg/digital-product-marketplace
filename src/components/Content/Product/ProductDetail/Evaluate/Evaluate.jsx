...
//       <h3 className={styles.title}>Cảm nhận của khách hàng</h3>
...
//             Bộ UI kit này thực sự tuyệt vời... (rút gọn)
//           </p>
//           <p className={styles.date}>2 tuần trước ★★★★★</p>
//         </div>
...
//           </p>
//           <p className={styles.comment}>
//             Tôi đã mua bộ UI kit này... (rút gọn)
//           </p>
//           <p className={styles.date}>1 tháng trước ★★★★★</p>
//         </div>
//       </div>
  ...
  return (
    <div className={styles.evaluate}>
      <div className={styles.header}>
        ...
        <button className={styles.writeButton}>Viết đánh giá</button>
      </div>
